"""Functional API for modification localisation isomers."""
...
def localization_isomers(peptide: str | ProFormaAnnotation | HasSequence, *, max_isomers: int | None = None) -> list[ProFormaAnnotation]:
...
def site_determining_ions(
    ...
    *,
    ...
    :class:`Fragment` objects ``fragment()`` returns, in the same order.
    ...
    :param tolerance: Match tolerance; None compares m/z exactly (within 1e-6 Da).
